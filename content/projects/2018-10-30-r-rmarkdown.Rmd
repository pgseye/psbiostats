...
As always, raw output is not very presentable, so let's try and do some formatting.
...
rownames(citab) <- c("Intercept", "Age", "Sex", "Refraction - Sphere", "Refraction - Cylinder", "Time spent outdoors - less than 1/4 day", "Time spent outdoors - 1/2 day", "Time spent outdoors - more than 3/4 day", "Time spent outdoors - cannot judge", "Head circumference at birth")
citab_classical_mod <- cbind("Coefficient" = rownames(citab), citab[,1:2], "Coefficient Lower C.I." = citab[,4], "Coefficient Upper C.I." = citab[,5], "Odds Ratio" = exp(citab[,1]), "Odds Ratio lower C.I." = exp(citab[,4]), "Odds Ratio upper C.I." = exp(citab[,5]), "P-value" = citab[,3])
